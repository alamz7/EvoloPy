...
def selector(algo, func_details, popSize, Iter):
    ...
    if algo == "SSA":
       ...
       #return null   
       #Gives error message "Null is not defined".
       #Hence using the following line of coee instead.
       return None
    return x
            ...
            for k in range(0, NumOfRuns):
                ...
                if Export_details == True:
                    ...
                    with open(ExportToFile, "a", newline="\n") as out:
                        ...
                        #The above line used to cause teh error as "ValueError: setting an array element with a sequence. The requested array has an inhomogeneous shape after 1 dimensions. The detected shape was (4,) + inhomogeneous part."
                        # Therefroe, the following code is being used instead of the above one. The code is sugggested by Googe Bard after trial and error. 
